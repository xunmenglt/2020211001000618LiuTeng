		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>order Date</td>
					<%
						com.liuteng.model.Order o=(com.liuteng.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.liuteng.dao.UserDao userDao=new com.liuteng.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.liuteng.model.Payment.findByPaymentId(con,n);
						%>
